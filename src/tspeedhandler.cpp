...
void TrtmComposition::saveToXMLFile(const QString &xmlName)
{
    ...
    if (file.open(QIODevice::WriteOnly)) {
        ...
        xml.writeStartElement("metronomek"_L1);
        if (!m_title.isEmpty())
            xml.writeTextElement("title"_L1, m_title);
    ...
    if (file.open(QIODevice::ReadOnly)) {
        ...
        if (xml.readNextStartElement()) {
            ...
            while (xml.readNextStartElement()) {
                ...
                } else if (xml.name() == "tempoChange"_L1) {
...
{
    return GLOB->TR(u"TempoPage"_s, u"Rhythmic Composition"_s) + QString(" #%1").arg(static_cast<qreal>(nr), 2, 'g', -1, '0');
}

TspeedHandler::TspeedHandler(QObject *parent)
    : QObject(parent)
{
    m_fileNames = GLOB->settings()->value(u"rhytmicFiles"_s, QStringList()).toStringList();
...
void TspeedHandler::saveCurrentComposition()
{
    ...
    GLOB->settings()->setValue(u"rhytmicFiles"_s, m_fileNames);
}
