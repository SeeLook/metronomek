...
Tdialog {
    ...
    leftPadding: GLOB.fontSize() / 2
    rightPadding: GLOB.fontSize() / 2
    topPadding: 0
    ...
    Flickable {
        width: parent.width
        height: infoPage.height - infoPage.topPadding * 2 - logo.height
        anchors.top: logo.bottom
        clip: true
        contentWidth: parent.width
        contentHeight: col.height + 4 * GLOB.fontSize()
